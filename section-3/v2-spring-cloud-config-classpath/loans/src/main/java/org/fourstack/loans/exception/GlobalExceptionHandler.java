...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleException(LoanAlreadyExistsException exception, WebRequest request) {
    ...
    private static FieldValidationError generateFieldError(String fieldError, String fieldName, String rejectedValue) {
        return new FieldValidationError(fieldName, rejectedValue, fieldError);
    }
